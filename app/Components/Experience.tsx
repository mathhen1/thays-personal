const Experience = () => {
    ...
    return (
        <div id="experience" className="flex flex-col items-center gap-3 border-t bg-pink-200 text-black">
            <h1 className="reveal2 opacity-0 text-center mt-2 text-xl border-b-2 font-black text-fuchsia-700 font-roboto">
                Experiência
            </h1>
            ...
            <h2 className="reveal2 opacity-0 text-lg border-b-2 font-black tracking-tighter text-fuchsia-700">
                Onde já trabalhei?
            </h2>

            <div className="flex flex-row w-11/12 mb-5">
                <ul className="reveal2 opacity-0 flex flex-col items-start gap-1 flex-1 border-2 border-r-1 text-xs text-nowrap bg-fuchsia-400">
                ...
                <ul className="reveal2 opacity-0 flex flex-col items-start gap-1 flex-1 border-2 border-l-1 border text-xs text-nowrap bg-fuchsia-400">
                    <li className="reveal2 opacity-0 text-black font-black p-2 tracking-tighter text-black">
