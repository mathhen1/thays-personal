const AboutMeMore = () => {
    return (
        <div id="about-me" className="reveal opacity-0 flex flex-col items-center w-screen h-full gap-5 text-black bg-purple-300">
            ...
            <div className="flex flex-col lg:flex-row items-center lg:justify-center p-2 gap-3 w-full text-center font-semibold tracking-tighter">

                <div className="flex flex-col items-center gap-3 p-2 lg:w-1/2">
                    ...
                    <div className="hidden lg:flex flex-col items-center gap-3 p-2">
                        <h3 className="reveal opacity-0 text-sm p-1 w-11/12">
            ...
            <div className="flex flex-col items-center p-2 gap-3 w-full text-center font-semibold tracking-tighter lg:hidden">
